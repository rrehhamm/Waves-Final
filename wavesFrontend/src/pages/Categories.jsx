    ...
    useEffect(() => {
        const loadFilterOptions = async () => {
            try {
                ...
                console.error('Failed to load categories page filters:', error);
            } finally {
                setLoading(false);
            }
        };
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-10 pb-6 border-b border-gray-100">
                    <div>
                        ...
                        <p className="text-gray-500 text-sm mt-1">{t('categoriesPage.subtitle')}</p>
                    </div>
                </div>
                ...
                <div className="flex flex-col lg:flex-row gap-8">
                    ...
                    <main className="flex-1">
                        ...
                        {productsLoading ? (
                            ...
                            <EmptyStateComponent message={t('categoriesPage.noResults')} />
                        )}
